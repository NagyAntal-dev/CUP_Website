                                ...
                                <div class="col-lg-7 col-md-9">
                                    <div class="caption center">
                                        <h1 data-splitting class="playfont"><a href="#0">
                                                Vestibulum bibendum </a>
                                        </h1>
                                        <p>Ut faucibus vestibulum orci, id auctor velit aliquet quis. In justo augue,
                                            gravida non purus non, faucibus sagittis libero. </p>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7 col-md-9">
                                    <div class="caption center">
                                        ...
                                        <p>Nunc auctor orci eget nisl mattis venenatis. Sed ac risus elementum,
                                            dignissim turpis in, lobortis tortor. Ut id pellentesque purus. </p>
                                        <a href="#0" class="btn-curve btn-color mt-20">
                                            <span>Ajánlatkérés</span>
                                        </a>
                                    </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 col-md-9">
                                    <div class="caption center">
                                        <h1 data-splitting class="playfont"><a href="#0">
                                                Suspendisse mauris </a>
                                        </h1>
                                        <p>Maecenas felis magna, tempor in odio quis, consequat tincidunt lacus. </p>
                                        <a href="#0" class="btn-curve btn-color mt-20">
                                            <span>Ajánlatkérés</span>
                                        </a>
                                    </div>
